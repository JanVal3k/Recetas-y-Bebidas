...
const IngredientesYPreparacion = ({ idReceta }) => {
  ...
  return (
    <div className="flex flex-col items-center w-full h-full p-2 sm:p-4">
      <div className="relative w-full h-full max-w-[800px] aspect-[4/3] sm:aspect-[16/10] bg-gray-200 rounded-2xl overflow-hidden transition-all duration-400">
        <img
...
export default IngredientesYPreparacion;
{
  /* <div className="flex flex-col items-center w-full md:w-auto">
      <div className="relative w-full md:w-[800px] md:h-[500px] sm:w-[800px] sm:h-[500px] bg-gray-200 rounded-2xl overflow-hidden m-6 transition-all duration-400">
        <img
          src={detallesReceta[0].strMealThumb}
          alt={detallesReceta[0].strMeal}
